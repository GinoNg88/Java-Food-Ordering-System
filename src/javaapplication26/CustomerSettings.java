...
private String filePath = "resources/Users.txt";
     ...
     */
    public CustomerSettings(Customer_1 user) {
        initComponents();
        this.user = user;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        sc.updateUserDetails(user, filePath, usernameField.getText(), passwordField.getText(), emailField.getText(), phonenumberField.getText());
